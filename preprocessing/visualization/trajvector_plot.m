function [] = trajvector_plot(obs)
%UNTITLED2 Summary of this function goes here
%   Detailed explanation goes here
rv1 = [ 0.2275, 0, -0.015];
rv2 = [-0.2275, 0, -0.015];

inds = 1:20:numel(obs.pose123.time_steps);
rftinds = 1:200:numel(obs.pose123.time_steps)*10;
...
sgtitle(sprintf('%s    %s    %s    Kinematics tlag:%.2d', obs.obs_id, obs.traj_type, obs.motion_type, ...
    mean(obs.pose123.time_steps(inds)-obs.rft1.time_steps(10*inds))), 'Interpreter','none');
end
